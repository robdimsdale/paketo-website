...
The Node.js buildpack supports the full [software bill of materials]({{< ref "docs/concepts/bom" >}}) (SBOM). For Node applications, the SBOM contains:
...
guide]({{< ref "docs/howto/bom" >}}) for more information about how to retrieve
